...
**XXXXX Trop de données manquantes, 4683 patients supprimés. Peut-on considérer que les données manquantes pour le diabète, l'IC, l'avc et le cancer sont égales à 0 ? Ou on fait une imputation multiple ? Pour l'IMC on a 4421 données manquantes, à imputer ?**
...
**XXXXX Quelle catégorie mettre en référence ? Ajuster sur quelles variables ?**
